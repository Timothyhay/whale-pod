...
Vendored verbatim from deepseek-ai/DeepSeek-V4-Flash-0731 (MIT license) so the
offline KVCache bench measures the *same byte stream the server fast-tokenizes*
for prefix caching. Keeping the upstream file byte-identical makes it auditable
against the source; do not hand-edit this encoder.

  source: https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731/blob/main/encoding/encoding_dsv4.py
"""
